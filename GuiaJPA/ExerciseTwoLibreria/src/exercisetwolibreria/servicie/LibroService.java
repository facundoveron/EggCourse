...
import exercisetwolibreria.persistence.LibroPersistence;
...
public class LibroService {
    ...
    /**
     * Method that queries and displays books by author 
     * 
     * @param nameAutor
     * @throws Exception 
     */
    ...
    /**
     * Method that queries and displays books by isbn
     * 
     * @param isbn
     * @return libro
     * @throws Exception 
    ...
    public Libro searchBookByIsbn(Long isbn) throws Exception{
        try {
            ...
            Libro libro = libroPersistence.searchBookByIsbn(isbn);
            return libro;
        } catch (Exception e) {
            throw e;
        }
    ...
    public void updateBook(Libro book) throws Exception{
        try {
            if(book == null){
